...
use ckb_testtool::ckb_types::{
    bytes::Bytes, core::TransactionView, prelude::*, H256, packed::{
		self, *
	}
};
...
use ckb_testtool::ckb_crypto::secp::{
	Privkey, Pubkey
};
...
pub fn axon_checkpoint_data(period: u64, half_period: u64, sudt_type_hash: &Byte32) -> axon::CheckpointLockCellData {
...
pub fn axon_stake_data(quorum: u8, checkpoint_type_hash: &Byte32, infos: Vec<axon::StakeInfo>) -> axon::StakeLockCellData {
	let stake_infos = axon::StakeInfoVec::new_builder()
		.set(infos)
		.build();
